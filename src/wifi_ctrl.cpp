...
WiFiConnect::WiFiConnect(WiFi_* pWiFi){
  pWiFi_ = pWiFi;
  init();
  wifiManuReqf = false;
}
...
void WiFiConnect::withStaReconnect(void)       // 接続要求：STA再接続要求
{
 ...
 */
WiFiConSts WiFiConnect::getWiFiConSts(void)
{
  return wifiConSts;
}
 ...
 */
void WiFiConnect::wifiModeSet(uint8_t mode,WiFiConSts nextSqf)
{
  bool ret;
 ...
 * @return false  接続失敗
 */
bool WiFiConnect::staConnect(char *ssid,char *pass,WiFiConSts nextSqf)
{
  bool ret;
  if(strlen(ssid) != 0){
 ...
 * @return false 
 */
bool WiFiConnect::escape(WiFiConSts nextSqf)
{
  if(wifiManuReqf){
    wifiManuReqf = false;
    pWiFi_->_print("- 強制中断 -");
 ...
 * @return false 
 */
bool WiFiConnect::noConnection(void)            // 接続なし
{
  bool ret = true;
 ...
 * @return false 
 */
bool WiFiConnect::sntpModeset(void)
{
  bool ret = true;
 ...
 * @return false 
 */
bool WiFiConnect::sntpStaStart(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::sntpStaCon(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::sntpStaComp(void)
{
  //  WiFi自動接続完了・SNTP初期化
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 */
bool WiFiConnect::sntpConnect(void)
{
  bool ret = false;
  unsigned long tm = pWiFi_->_millis();
  // SNTP処理完了まち
 ...
 * @return false 
 */
bool WiFiConnect::manModeset(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::manApStart(void)
{
  bool ret;
  unsigned long tm = pWiFi_->_millis();
  if(tm - timetmp > 500){
 ...
 * @return false 
 */
bool WiFiConnect::manApConp(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
  if(tm - timetmp > 100){
 ...
 * @return false 
 */
bool WiFiConnect::manMdnsStart(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::manStaStart(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::manStaCon(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::manConnectComp(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::staReConnectDis(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::staReConnect(void)            // STA再接続 STA再接続
{
  bool ret = true;
 ...
 * @return false 
 */
bool WiFiConnect::staReConnectCon(void)         // STA再接続 STA接続待ち
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::apDisconnection(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * @return false 
 */
bool WiFiConnect::staDisconnection(void)
{
  bool ret = true;
  unsigned long tm = pWiFi_->_millis();
 ...
 * 
 */
void WiFiConnect::staDisconCollBack(void)
{
 ...
 */
void WiFiConnect::apStopCollBack(void)
{
